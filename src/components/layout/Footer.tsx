  ...
  return (
    <footer className="bg-gray-100 pt-12 pb-8">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          <div>
            ...
            <ul className="space-y-2">
              <li><Link to="/listings" className="text-gray-600 hover:text-roverpass-purple">Browse Listings</Link></li>
              <li><Link to="/broker/dashboard" className="text-gray-600 hover:text-roverpass-purple">Broker Dashboard</Link></li>
              <li><Link to="/listings/featured" className="text-gray-600 hover:text-roverpass-purple">Featured Properties</Link></li>
              <li><Link to="#" className="text-gray-600 hover:text-roverpass-purple">Recently Sold</Link></li>
            </ul>
          </div>
          <div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li className="text-gray-600">Email: sales@roverpass.com</li>
              <li className="text-gray-600">Phone: (512) 555-1234</li>
              <li className="flex space-x-4 mt-4">
                <a href="#" className="text-gray-600 hover:text-roverpass-purple">
        ...
        <div className="border-t border-gray-200 pt-4 mt-4 text-center text-sm text-gray-500">
          <p>© {new Date().getFullYear()} RoverPass. All rights reserved.</p>
          <div className="flex justify-center space-x-4 mt-2">
            <Link to="#" className="hover:text-roverpass-purple">Terms of Service</Link>
            <Link to="#" className="hover:text-roverpass-purple">Privacy Policy</Link>
            <Link to="#" className="hover:text-roverpass-purple">Cookie Policy</Link>
          </div>
        </div>
      </div>
    </footer>
